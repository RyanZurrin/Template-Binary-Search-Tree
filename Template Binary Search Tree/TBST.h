...
class TBST 
{
	...
	/// <returns></returns>
	bool retrieve(node<T>* tree, const T k, T& found)const;
	/// <summary>
	/// Copies the tree.
	/// </summary>
...
/// </summary>
	...
	/// </summary>
	/// <param name="originalTree">The original tree.</param>
	TBST(const TBST<T>& originalTree);
	...
	/// </summary>
	/// <param name="originalTree">The original tree.</param>
	void operator=(TBST<T>& originalTree);
...
template<typename T>
inline TBST<T>::TBST(const TBST<T>& originalTree)
{
...
template<typename T>
inline void TBST<T>::operator=(TBST<T>& originalTree)
{
